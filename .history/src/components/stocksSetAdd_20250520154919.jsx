...
const handleSubmit = async (e) => {
  ...
  prices={formData.stocks}
  onNumberChange={(e, index) => handleStockChange(index, 'quantity', e.target.value)}
  onCountChange={(e, index) => handleStockChange(index, 'id', e.target.value)}
  // ... digər proplar
/>
