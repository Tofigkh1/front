...
const handleSave = async () => {
  ...
  const validStocks = selectedStockSet.stocks.map(stock => ({
    ...
    price: stock.price, // backend bunu da bekliyorsa
  }));
  ...
  try {
    ...
    // image varsa ve File nesnesiyse base64 veya fileName olarak eklenebilir,
    // ama backend sadece string bekliyorsa şöyle yapın:
    if (formData.image && typeof formData.image !== "object") {
      payload.image = formData.image; // örneğin 'pox'
    }
