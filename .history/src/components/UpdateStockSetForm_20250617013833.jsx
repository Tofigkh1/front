...
const UpdateStockSetForm = () => {
  ...
  console.log("selectedStockSet",selectedStockSet.id);
...
const handleSave = async () => {
  ...
  try {
    ...
    if (formData.image instanceof File) {
      formDataToSend.append("image", formData.image); // ✅ Görsel dosyasını gönderiyoruz
    }
    ...
    const response = await axios.post( // veya PUT, backend'e göre değişir
