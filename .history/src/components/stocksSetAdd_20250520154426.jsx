...
formData.additionalPrices.forEach((priceObj) => {
  if (priceObj.price && priceObj.unit && priceObj.count) {
    formDataToSend.append(`additionalPrices[][price]`, priceObj.price);
    formDataToSend.append(`additionalPrices[][unit]`, priceObj.unit);
    formDataToSend.append(`additionalPrices[][count]`, priceObj.count);
  }
});
