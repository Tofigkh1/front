...
const [itemToRemove, setItemToRemove] = useState(null);
  ...
  <ScreenPassword
    onSuccess={() => {
      // 🔓 Şifre doğruysa asıl silme işlemini yap
      handleRemoveStock(itemToRemove.id, itemToRemove.pivot_id, itemToRemove.quantity);
      setShowPasswordScreen(false); // Modalı kapat
      setItemToRemove(null); // Seçili öğeyi temizle
    }}
    onCancel={() => {
      // ❌ Kullanıcı vazgeçerse modalı kapat
