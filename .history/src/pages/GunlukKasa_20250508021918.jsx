...
function GunlukKasa() {
    ...
    <table className='w-full text-left border rounded bg-[#fafbfc] mb-3'>
        ...
        <tbody>
        {data.map((item) => (
  <tr key={item.id} className="border-b"> {/* Her satırın altına çizgi */}
    <td className='p-2 md:p-3 border-r'>{item.order_name}</td>
    <td className='p-2 md:p-3 border-r'>{item.open_date}</td>
    <td className='p-2 md:p-3 border-r'>{item.close_date}</td>
    <td className='p-2 md:p-3 border-r'>{item.duration}</td>
    <td className='p-2 md:p-3 border-r'>{item.total_amount} ₼</td>
    ...
    <td className='p-2 md:p-3 border-r'>{item.user_name}</td>
    <td className='p-2 md:p-3'>
      <button
        className='rounded py-1 px-3 bg-blue-600 text-white'
        onClick={() => showModal(item)}
