...
const base_url = 'https://sənin-api-adresin.com'; // API baz URL
...
function Expenses() {
  ...
  const fetchCategories = async () => {
    try {
      const res = await axios.get(`${base_url}/api/expense-categories`, getHeaders());
  ...
  const createCategory = async () => {
    try {
      await axios.post(`${base_url}/api/expense-categories`, { name: newCategoryName }, getHeaders());
      setNewCategoryName('');
      fetchCategories();
    } catch (err) {
  ...
  const fetchCategoryExpenses = async (categoryId) => {
    try {
      const res = await axios.get(`${base_url}/api/expense-categories/${categoryId}/expenses`, getHeaders());
  ...
  const addExpense = async () => {
    try {
      await axios.post(`${base_url}/api/expense-categories/${selectedCategoryId}/expenses`, {
