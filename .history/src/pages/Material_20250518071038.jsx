...
const idd = rawMaterials.length > 0 ? rawMaterials[0].id : null;
...
console.log("id",idd);
  ...
  const category = [
    ...
    { id: 4, label: "Qram" },
      ...
      useEffect(() => {
    axios.get(`${base_url}/raw-materials/${id}/logs`)
      .then(response => {
        setLogs(response.data); // API'nin response yapısına göre uyarlayabilirsin
