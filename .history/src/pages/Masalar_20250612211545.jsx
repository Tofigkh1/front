...
{table.total_price !== undefined && table.total_price !== null ? (
  Number(table.total_price) !== 0 ? (
    <strong className="text-md sm:text-lg lg:text-xl">
      ₼ {table.total_price}
    </strong>
  ) : (
    <strong className="text-md sm:text-lg lg:text-xl text-gray-600">
      Boşdur
    </strong>
  )
) : (
  <strong className="text-md sm:text-lg lg:text-xl text-white">
    Boşdur
  </strong>
)}
